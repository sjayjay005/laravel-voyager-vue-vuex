...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vuex_persistedstate__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_js_cookie__ = __webpack_require__(44);
  ...
  getters: {
    getPost: function getPost(state) {
      return function (slug) {
        return state.posts.find(function (singlePost) {
          return slug == singlePost.slug;
        });
      };
    }
  },
...
router.beforeEach(function (to, from, next) {
  ...
  if (to.name === 'post' && __WEBPACK_IMPORTED_MODULE_3__store__["a" /* default */].getters.getPost(to.params.post)) {
    next();
  } else if (to.name === 'home' && __WEBPACK_IMPORTED_MODULE_3__store__["a" /* default */].state.post_summaries.length > 0) {
    next();
...
Component.options.__file = "resources/assets/js/components/shared/Page.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4eec7952", Component.options)
  } else {
    hotAPI.reload("data-v-4eec7952", Component.options)
  }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getPost; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getHome; });
...
var getPost = function getPost(slug) {
  ...
  if (__WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].getters.getPost(slug)) return;

  __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/api/post/' + slug).then(function (_ref) {
    var data = _ref.data;

    __WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].commit('addData', { route: 'post', data: data });
  });
};
...
var getHome = function getHome() {
  ...
  if (__WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].state.post_summaries.length > 0) return;

  __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/api/').then(function (_ref2) {
    var data = _ref2.data;

    __WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].commit('addData', { route: 'home', data: data });
  });
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_meta__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__router__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_App_vue__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_views_TheHomePage__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_views_TheHomePage___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_views_TheHomePage__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_views_ThePostPage__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_views_ThePostPage___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_views_ThePostPage__);



var routes = [{ path: "/", component: __WEBPACK_IMPORTED_MODULE_0__components_views_TheHomePage___default.a, name: "home" }, { path: "/post", component: __WEBPACK_IMPORTED_MODULE_0__components_views_TheHomePage___default.a, name: "random" }, { path: "/post/:post", component: __WEBPACK_IMPORTED_MODULE_1__components_views_ThePostPage___default.a, name: "post" }];
...
Component.options.__file = "resources/assets/js/components/views/TheHomePage.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-270ddd52", Component.options)
  } else {
    hotAPI.reload("data-v-270ddd52", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_Page__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_Page___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__shared_Page__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadPost: function loadPost(slug) {
      Object(__WEBPACK_IMPORTED_MODULE_1__services__["b" /* getPost */])(slug);
    }
  },

  components: { Page: __WEBPACK_IMPORTED_MODULE_0__shared_Page___default.a }
});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4eec7952", module.exports)
  }
}
  ...
  return _c("page", { attrs: { classes: { "c-page--padded-top": false } } }, [
    _c("div", { staticClass: "c-section" }, [
      _c("div", { staticClass: "l-wrapper" }, [
        _c(
          "div",
          { staticClass: "c-container c-container--card" },
          _vm._l(_vm.postsList, function(post) {
            return _c(
              "div",
              {
                staticClass: "c-post-card",
                on: {
                  mouseover: function($event) {
                    _vm.loadPost(post.slug)
                  }
                }
              },
              [
                _c(
                  "router-link",
                  {
                    attrs: { to: { name: "post", params: { post: post.slug } } }
                  },
                  [
                    _c("div", { staticClass: "c-post-card__head" }, [
                      _c("img", { attrs: { src: post.thumb } })
                    ]),
                    _vm._v(" "),
                    _c("div", { staticClass: "c-post-card__body" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-270ddd52", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/views/ThePostPage.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d87d37d0", Component.options)
  } else {
    hotAPI.reload("data-v-d87d37d0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  metaInfo: function metaInfo() {
    return {
      ...
      meta: [{ vmid: 'description', name: 'description', content: this.post.excerpt ? this.post.excerpt : 'Loading' }]
    };
  },
  mounted: function mounted() {},
  destroyed: function destroyed() {},
  ...
  computed: {
    post: function post() {
      ...
      var realPost = this.$store.getters.getPost(this.$route.params.post);
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("page", { attrs: { classes: { "c-page--padded-top": false } } }, [
    _c("div", { staticClass: "c-post" }, [
      _vm.post
        ? _c(
            "div",
            {
              staticClass: "c-post-head",
              style: { "background-image": "url(" + _vm.post.image + ")" }
            },
            [
              false
                ? _c("img", {
                    staticClass: "c-post-head__bg",
                    attrs: { src: _vm.post.image }
                  })
                : _vm._e(),
              _vm._v(" "),
              _c("h1", { staticClass: "c-post-head__title" }, [
      ...
      _vm._v(" "),
      _vm.post
        ? _c("div", { staticClass: "c-post-body" }, [
            _c("div", { staticClass: "l-wrapper" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-d87d37d0", module.exports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_navigation_TheNavigation_vue__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_navigation_TheNavigation_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__shared_navigation_TheNavigation_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_navigation_TheFooter_vue__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_navigation_TheFooter_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__shared_navigation_TheFooter_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    TheNavigation: __WEBPACK_IMPORTED_MODULE_0__shared_navigation_TheNavigation_vue___default.a,
    TheFooter: __WEBPACK_IMPORTED_MODULE_1__shared_navigation_TheFooter_vue___default.a
  }
});
...
Component.options.__file = "resources/assets/js/components/shared/navigation/TheNavigation.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4f38a22d", Component.options)
  } else {
    hotAPI.reload("data-v-4f38a22d", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_js__ = __webpack_require__(15);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    loadHome: function loadHome() {
      Object(__WEBPACK_IMPORTED_MODULE_0__services_js__["a" /* getHome */])();
    }
  }
  ...
  return _c(
    ...
    [
      _c("router-link", { attrs: { to: { name: "home" } } }, [
        _c("div", {
          staticClass: "c-navigation__logo",
          on: { mouseover: _vm.loadHome }
        })
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "c-navigation__menu" })
    ],
    1
  )
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4f38a22d", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/shared/navigation/TheFooter.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-963fca98", Component.options)
  } else {
    hotAPI.reload("data-v-963fca98", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-963fca98", module.exports)
  }
}
